...
// 				// Yaw aponta na direção do cometa; somamos Pi para ficar ATRÁS dele
// 				orbitCam.Yaw = float32(math.Atan2(float64(direction.X), float64(direction.Z))) + math.Pi
// 				// Pitch: ângulo vertical da direção de movimento (sinal correto para "olhar para frente")
// 				orbitCam.Pitch = float32(math.Asin(float64(direction.Y)))
// 				orbitCam.Distance = 40.0
// 			} else {
// 				// Cometa parou (impacto ou saiu): volta para câmera livre
// 				cameraMode = cameraModeFree
// 			}
// 		}
